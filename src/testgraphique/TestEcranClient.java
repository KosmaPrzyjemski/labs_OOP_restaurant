...
public class TestEcranClient {
	...
	public static void main(String[] args) {
		...
		controlAjouterAlimentCarte.ajouterAliment(AlimentMenu.ACCOMPAGNEMENT,
				"Baked Potatos");
		controlAjouterAlimentCarte.ajouterAliment(AlimentMenu.BOISSON, "Coca Cola");
		controlAjouterAlimentCarte.ajouterAliment(AlimentMenu.BOISSON, "English IPA");
		controlAjouterAlimentCarte.ajouterAliment(AlimentMenu.BOISSON, "Sparkling water");
